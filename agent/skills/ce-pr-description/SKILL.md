...
Callers that need to ask the user are responsible for using their own platform's blocking question tool (`ask_user_question` in Claude Code, `request_user_input` in Codex, `ask_user` in Gemini) before or after invoking this skill.
