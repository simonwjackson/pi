...
Then offer next steps (use the platform's question tool — `ask_user_question` in Claude Code, `request_user_input` in Codex, `ask_user` in Gemini — or present numbered options and wait):
