...
When this skill is used through `/think`, the durable artifact is an optional **thinking memo**.

- Save path: `docs/thinking/YYYY-MM-DD-<topic>-think.md`
- The memo is optional; the thinking session is still complete without it
- The memo should capture reasoning, assumptions, trade-offs, tensions, and open questions
- The memo is **not** a brief or implementation plan
- `/shape` may later use the memo as background context, but `/spec` should not depend on it when a brief exists
...
If the user requests it, offer to save the analysis as a thinking memo at `docs/thinking/YYYY-MM-DD-<topic>-think.md`. Keep it as reasoning support, not a brief or implementation plan.
